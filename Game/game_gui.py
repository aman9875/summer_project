...
import setting_ships_game
import battleship_test_game
import machine_learning_game
import time
...
ClickSound = pygame.mixer.Sound('Click2.wav')
...
def main():
	...
	if mode == 1:
		battleship_test_game.main()
	elif mode == 2:
		machine_learning_game.main()
...
def writeMove(number):
	#print("move1 = %d move 2 = %d"%(movePlayer1,movePlayer2))
	message = ""
	if number == 1:
		x = XMARGIN
